...
<div class="row" style="margin: 20px 0;">
	<?php $form = ActiveForm::begin(['id' => 'meetForm', 'action' => rtrim('/contracts/task-analysis-doc/'.$taskForm->getContract()->primaryKey.'/'.$taskForm->getTask()->primaryKey, '/'), 'enableClientValidation' => FALSE, 'fieldClass' => 'common\extensions\widgets\SmartActiveField', 'options' => ['class' => 'smart-form', 'data-id' => $taskForm->getContract()->primaryKey]]); ?>
