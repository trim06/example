...
<?php $form = ActiveForm::begin(['id' => 'contractForm', 'action' => '/contracts/create', 'enableClientValidation' => FALSE, 'fieldClass' => 'common\extensions\widgets\SmartActiveField', 'options' => ['class' => 'smart-form']]); ?>
	<div class="col-xs-7 col-sm-9">
		<div class="piece-of-sheet">
			<?= $this->render('_form', ['form' => $form, 'contractForm' => $contractForm, 'isCreateContract' => true]); ?>
		</div>
	</div>
	<div class="col-xs-5 col-sm-3 list-actions">
		...
		<?= Html::submitButton('Договор', ['data-action' => 'agreement', 'title' => 'Договор', 'class' => 'btn btn-block btn-sm btn-success', 'onclick' => 'return contracts.action(this);']); ?>
		</div>
	</div>
<?php ActiveForm::end(); ?>
</div>
