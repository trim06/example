<?php
/**
 * Представление для редактирования кредитов
 * @var $contractCreditForm crm\modules\contracts\models\ContractCreditForm - форма редактирования кредита по договору
 */
