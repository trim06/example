...
<div class="row" style="margin: 0;">
	<div class="col-sm-8 col-sm-push-4 document-actions" data-contract_id="<?=$contractId;?>" data-file_id="<?=$fileId;?>">
		<div class="col-sm-6">
			<button class="btn btn-block btn-sm btn-primary" onclick="main.documents.cancel(this);">Отмена</button>
		</div>
		<div class="col-sm-6">
			<button class="btn btn-block btn-sm btn-success" onclick="main.documents.saveDocument(this);">Сохранить документ</button>
		</div>	
	</div>
</div>
